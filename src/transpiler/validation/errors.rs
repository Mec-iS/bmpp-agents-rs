...
pub enum ParameterFlowError {
    ...
    #[error("Parameter '{parameter}' has multiple producers {producers:?} in protocol '{protocol}'")]
    MultipleProducers { parameter: String, producers: Vec<String>, protocol: String },
    ...
    UndeclaredParameter { parameter: String, interaction: String, protocol: String },
}
